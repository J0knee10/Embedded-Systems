...
class MCP:
    ...
    def __init__(self, chip, i2cAddress):
...
if __name__ == "__main__":
    ...
    for i in [1,2,3,4]:
        MCP3.output(2*i-2, 1)
        MCP3.output(2*i-1, 0)
        print(f'status 1, pin{2*i-2}, {2*i-1}')
        time.sleep(0.5)
        MCP3.output(2*i-2, 0)
        MCP3.output(2*i-1, 1)
        print(f'status 2, pin{2*i-2}, {2*i-1}')
        time.sleep(0.5)
        MCP3.output(2*i-2, 0)
        MCP3.output(2*i-1, 0)
    '''
    for i in [2]:
        MCP3.output(i, 1)
        print(f'status 1, pin{i}')
        time.sleep(0.5)
        MCP3.output(i, 0)
        print(f'status 2, pin{i}')
        time.sleep(0.5)
        MCP3.output(i, 0)
