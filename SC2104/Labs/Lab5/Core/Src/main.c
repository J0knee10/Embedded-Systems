...
{   int roll_ServoVal;        // PWM servo value for roll servo motor
	...
	pid_output = kp * roll_error + ki * roll_error_area + kd * roll_error_rate;
	roll_ServoVal = (int)(roll_servo_target - pid_output);
...
{   int pitch_ServoVal;       // PWM servo value for Pitch servo motor
	...
	pid_output = kp * pitch_error + ki * pitch_error_area + kd * pitch_error_rate;
	pitch_ServoVal = (int)(pitch_servo_target - pid_output);
