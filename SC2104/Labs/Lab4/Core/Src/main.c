...
int32_t pwmVal=222;       //pwm value to control motor speed
...
int16_t pwmMin = 221;    // offset value to compensate for deadzone
...
int main(void)
{
  ...
  while (1){
  	  ...
  	  // pwmVal += 5;          // this will overwrite PID control above start turning at pwmVal = 222
